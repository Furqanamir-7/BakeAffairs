...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    title: "Cupcakes",
    items: [
      { name: "Whipcream cupcakes 6pcs", price: "Rs. 1,300" },
      { name: "Whipcream cupcakes 12", price: "Rs. 2,200" },
      { name: "Buttercream cupcakes 6pcs", price: "Rs. 2,000" },
      { name: "Buttercream cupcakes 12pcs", price: "Rs. 3,500" },
      { name: "Whipped cream one bite (20pcs)", price: "Rs. 2,000" },
      { name: "Buttercream one bite (20pcs)", price: "Rs. 3,000" },
