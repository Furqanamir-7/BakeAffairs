      ...
      <div className="container-px mx-auto max-w-3xl">
        <Reveal>
          <div>
            ...
            <ol className="mt-6 list-decimal space-y-4 pl-5 text-sm leading-relaxed text-cream/80 sm:text-base">
        ...
        <Reveal delay={0.1}>
          <div className="mt-14 border-t border-secondary/20 pt-12">
            <h2 className="font-serif text-2xl text-cream sm:text-3xl">
            ...
            <ul className="mt-6 list-disc space-y-4 pl-5 text-sm leading-relaxed text-cream/80 sm:text-base">
